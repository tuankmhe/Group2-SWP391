<%-- 
    Document   : Update
    Created on : May 20, 2023, 4:52:20 PM
    Author     : Mạc Huyền
--%>
...
<html>
    ...
    <body>
        <!--        <script>
                const img_input = document.querySelection("#img_input");
                var img = "";
                ...
                img_input.addEventListener("change", function () {
                    ...
                    reader.addEventListener("load", () => {
                        img = reader.result;
                        document.querySelector("img_display").style.backgroundImage = 'url(${img})';
                    });
                                    ...
                                    <div class="row gx-3 mb-3">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <select class="form-control" name="status" id="status">
                                                ...
                                                <option hidden
                                                        <c:if test="${customer.status eq 'Inactive'}">
                                                            selected="selected"
                                                        </c:if>
                                                        value="Inactive">Inactive
                                                </option>
                                                <option
                                                    <c:if test="${customer.status eq 'Contact'}">
                                                        selected="selected"
                                                    </c:if>
                                                    value="Contact">Contact
                                                </option>
                                                <option
                                                    <c:if test="${customer.status eq 'Potential'}">
                                                        selected="selected"
                                                    </c:if>
                                                    value="Potential">Potential
                                                </option>
                                                <option
                                                    <c:if test="${customer.status eq 'Customer'}">
                                                        selected="selected"
                                                    </c:if>
