<%-- 
    ...
    Created on : Jun 12, 2023, 3:47:38 PM
    Author     : Cao Gia Linh
--%>
...
<html  class="no-js" lang="en">
    <head>
        ...
        <title>BulkShop - Electronics Shop HTML Template | Element Product Category</title>
                        ...
                        <div class="row mb-30">
                            <div class="col-12">
                                <div class="product-category-img">
                                    <img src="assets/img/product-category.jpg" alt="img">
                                </div>
                            </div>
                        </div>
                        <!-- Product Category Image -->
                                    ...
                                    <div class="product-single">
                                        <div class="product-thumbnail">
                                            <a href="product-details.html">
                                                <img style="width: 100%; height: 250px" src="${p.pimg_url}" alt="product img"></a>
                                        ...
                                        <div class="product-content">
                                            <h4><a href="product-details.html">${p.product_name}</a></h4>
                                            <div class="pricing">
                                                <span>${p.sale} <del>${p.price}</del></span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
