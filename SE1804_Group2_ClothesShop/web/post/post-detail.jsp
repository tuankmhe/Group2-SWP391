<%-- 
    ...
    Created on : Jun 26, 2023, 5:35:22 PM
    Author     : Mạc Huyền
--%>
                    ...
                    <div class="col-lg-8">
                        <div class="blog-details">
                            <div class="blog-item">
                                ...
                                <div class="content">
                                    <ul class="auth">
                                        <li><a href="user-profile?userid=${post.auth.userid}">by ${post.auth.fullname}</a></li>
                                        <!--<li><a href="#">02 Comments</a></li>-->
                                        <li><a href="#">${post.cate.category_name}</a></li>
                                    </ul>
                                    <h1>${post.title}</h1>
                                    <p class="active">${post.summary}</p>
                                    <p>${post.content}</p>
