<%-- 
    Document   : list
    Created on : Jun 23, 2023, 10:36:22 PM
    Author     : Mạc Huyền
--%>
                        ...
                        <div class="col-lg-8">
                            ...
                            <c:forEach items="${requestScope.post}" var="p">
                                <div class="col-md-6 mb-30">
                                    <div class="blog-item">
                                        <div class="thumnail">
                                            <a href="single.html"><img src="./assets/img/blog/${p.thumbnail}" alt="blog"></a>
                                        </div>
                                        <div class="content">
                                            <ul class="auth">
                                                <li>
                                                    <c:forEach items="${p.author}" var="a">
                                                    <a href="user-profile?userid=${a.userid}">by ${a.fullname}</a>
                                                </c:forEach>
                                                </li>
                                            ...
                                            <h2>
                                                ${p.postid} | ${p.title}
                                                <!--<a href="single.html">Slow cooker apple cinnamon oatmeal pot </a>-->
                                            </h2>
                                            <p> ${p.summary} </p>
                                        </div>
                                    </div>
