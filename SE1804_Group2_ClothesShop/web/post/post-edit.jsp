<%-- 
    Document   : post-edit
    Created on : Jun 26, 2023, 1:19:21 AM
    Author     : Mạc Huyền
--%>
                                ...
                                <div class="privacy-policy-content">
                                    ...
                                    <div class="row gx-3 mb-3">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <select class="form-control" name="status" required>
                                                <option
                                                    <c:if test="${post.status eq 'Draft'}">
                                                        selected="selected"
                                                    </c:if>
                                                    value="Draft">Draft
                                                </option>
                                                ...
                                                <option
                                                    <c:if test="${post.status eq 'Published'}">
                                                        selected="selected"
                                                    </c:if>
                                                    value="Published">Published
                                                </option>
                                                <option
                                                    <c:if test="${post.status eq 'Future'}">
                                                        selected="selected"
                                                    </c:if>
                                                    value="Future">Future
                                                </option>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <select class="form-control" name="category" required>
                                                <c:forEach items="${category}" var="c">
                                                    <option
                                                        <c:if test="${post.cate.category_id eq c.category_id}">
                                                            selected="selected"
                                                        </c:if>
                                    ...
                                    <div class="thumnail text-center">
                                        <%--<c:if test="${post.thumbnail == null}">--%>
                                            <!--<img src="./assets/img/blog/${post.thumbnail}" alt="${post.title}">-->
                                        <%--</c:if>--%>
                                        <c:if test="${post.thumbnail != null}">
                                            <img src="./assets/img/blog/${post.thumbnail}" width="1000" alt="${post.title}">
                                        </c:if>
                                    </div>
                                        <br>
                                    <!-- Form Group (summary)-->
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control" rows="5" cols="100"type="string" length="1000"
                                                  name="summary" required>${post.summary}</textarea> 
                                    </div>
