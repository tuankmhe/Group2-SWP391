                            ...
                            <div class="card-body">
                                <form>
                                    ...
                                    <fieldset class="form-group">
                                        ...
                                        <input type="text" value="${o.createdDate}" class="form-control"
                                               name="createDate" id="createDate" readonly>
                                    </fieldset> 
                                    <fieldset class="form-group">
                                        <label>Total Price</label> 
                                        <input type="text" value="${o.total_price}" class="form-control"
                                               name="sale" id="sale" readonly>
                                    </fieldset>
<!--                                    <fieldset class="form-group">
                                        <label>Status</label> 
                                        <select class="from-control" name="status" required>
                                            <option value="${o.status}">${o.status}</option>
                                            <option value="Accpect">Accpect</option>
                                ...
                                <fieldset class="form-group">
                                    ...
                                    <input type="text" value="" class="form-control"
                                           name="full_name" id="name" readonly>
