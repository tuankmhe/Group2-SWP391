            ...
            <div>
                <div class="title text-center">
                    ...
                    <div style="margin-left: 100px; margin-right: 100px">
                        <table class="table table-striped table-bordered table-title" cellspacing="1" rules="all" border="1" id="gvLO"
                            ...
                            <c:forEach items="${p}" var="p">
                                <tr>
                                    ...
                                    <td><a href="orderdetail?order_id=${p.order_id}" class="btn btn-view">View</a></td>
                                </tr>
                            </c:forEach>
                        </tbody>
                    </table>
                    ...
                    <div class="page-pagination text-center">
                        <ul>
                            <li><a href="#"><i class="fa fa-angle-left"></i></a></li>
                                ...
                                <li><a href="orderlist?index=${i}">${i}</a></li>
