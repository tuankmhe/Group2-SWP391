<%-- 
    ...
    Created on : May 29, 2023, 2:55:27 PM
    Author     : Admin
--%>
				...
				<div class="col-lg-6 offset-lg-3">
					<div class="login-register-form-full">
						...
						<form action="register" method ="Post">
                                                    ...
                                                    <input type="name" class="form-control" name="uname" placeholder="Username" required="">
                                                    ...
                                                    <input type="password" class="form-control" name="re_pass" id ="confirm_password" placeholder="Confirm Password" required>
					            <button class="button-1" type="submit">Sign Up</button>
						</form>
						<p>Allready Have an Account? Please <a href="login">Login now</a></p>
					</div>
				</div>
			</div>
		</div>
