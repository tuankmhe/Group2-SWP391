<%-- 
    Document   : bloglist
    Created on : Jul 24, 2023, 4:18:24 AM
    Author     : BUI QUOC BAO
--%>
                ...
                <div class="row">
                            ...
                            <c:forEach items="${b}" var="b">
                                ...
                                <div class="col-md-6 mb-30">
                                    <div class="blog-item">
                                        ...
                                        <div class="thumnail">
                                            <a href="blogdetail?blog_id=${b.blog_id}"><img src="./assets/img/blog/${b.thumbnail_url}" alt="blog"></a>
                                        </div>
                                        <div class="content">
                                            <ul class="auth">
                    ...
                    <div class="col-lg-4">
                        ...
                        <div class="sidebar-widgets">
                            ...
                            <ul>
                                <li><a href="bloglist">All about Digital</a></li>
                                <c:forEach items="${c}" var="c">
                                    <li><a href="blogbycate?category_id=${c.category_id}">${c.category_name}</a></li>
                                </c:forEach>
